...
class GameScreen(Screen):
    ...
    def load(self, save_dir):
        #TODO remove this hardcoding
        for i in range(0, 17):
            shutil.copy('{0}{1}.json'.format(USER_SAVES_DIR + save_dir, i), '{0}{1}.json'.format(CURRENT_GAME_DIR, i))
            shutil.copy(USER_SAVES_DIR + save_dir + 'player.json', CURRENT_GAME_DIR + 'player.json')
